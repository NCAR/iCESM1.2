module ice_cpl_indices
  ...
  integer :: index_i2x_Fioi_meltw_HDO  ! isotopes
  integer :: index_i2x_Fioi_meltw_16O  ! isotopes
  integer :: index_i2x_Fioi_meltw_18O  ! isotopes
