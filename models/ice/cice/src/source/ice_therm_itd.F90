...
!
      ...
      use ice_state, only: nt_Tsfc, nt_iage, nt_FY, nt_aero, nt_iso, &
                           tr_iage, tr_FY, tr_aero, tr_iso, &
...
!
      ...
      use ice_state, only: nt_aero, tr_aero, nt_iso, tr_iso
!
! !INPUT/OUTPUT PARAMETERS:
!
      integer (kind=int_kind), intent(in) :: &
