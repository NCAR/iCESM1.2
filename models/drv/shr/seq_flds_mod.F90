...
!-------------------------------------------------------------------------------
     ...
     if (seq_comm_iamroot(ID)) then
        ...
        flds_co2c = .false.
        flds_co2_dmsa = .false.
        flds_wiso = .true.  !set default to true now, later input by  namelist
        glc_nec   = 0
     ...
     if (flds_wiso) then
      ...
      ! H218O Evaporation water flux
       ...
       ! l2x, x2r
       units    = 'kg m-2 s-1'
       call seq_flds_add(l2x_fluxes,'Flrl_rofice_16O')
       call seq_flds_add(x2r_fluxes,'Flrl_rofice_16O')
       longname = 'H2_16O Water flux from land (frozen)'
       stdname  = 'H2_16O_frozen_water_flux_into_runoff'
       attname  = 'Flrl_rofice_16O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(l2x_fluxes,'Flrl_rofice_18O')
       call seq_flds_add(x2r_fluxes,'Flrl_rofice_18O')
       longname = 'H2_18O Water flux from land (frozen)'
       stdname  = 'H2_18O_frozen_water_flux_into_runoff'
       attname  = 'Flrl_rofice_18O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(l2x_fluxes,'Flrl_rofice_HDO')
       call seq_flds_add(x2r_fluxes,'Flrl_rofice_HDO')
       longname = 'HDO Water flux from land (frozen)'
       stdname  = 'HDO_frozen_water_flux_into_runoff'
       attname  = 'Flrl_rofice_HDO'
       call metadata_set(attname, longname, stdname, units)

       call seq_flds_add(l2x_fluxes,'Flrl_rofliq_16O')
       call seq_flds_add(x2r_fluxes,'Flrl_rofliq_16O')
       longname = 'H2_16O Water flux from land (liquid)'
       stdname  = 'H2_16O_liquid_water_flux_into_runoff'
       attname  = 'Flrl_rofliq_16O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(l2x_fluxes,'Flrl_rofliq_18O')
       call seq_flds_add(x2r_fluxes,'Flrl_rofliq_18O')
       longname = 'H2_18O Water flux from land (liquid)'
       stdname  = 'H2_18O_liquid_water_flux_into_runoff'
       attname  = 'Flrl_rofliq_18O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(l2x_fluxes,'Flrl_rofliq_HDO')
       call seq_flds_add(x2r_fluxes,'Flrl_rofliq_HDO')
       longname = 'HDO Water flux from land (liquid)'
       stdname  = 'HDO_liquid_water_flux_into_runoff'
       attname  = 'Flrl_rofliq_HDO'
       call metadata_set(attname, longname, stdname, units)

       ! r2x, x2o
       call seq_flds_add(r2x_fluxes,'Forr_roff_16O')
       call seq_flds_add(x2o_fluxes,'Forr_roff_16O')
       longname = 'H2_16O Water flux due to liq runoff '
       stdname  = 'H2_16O_water_flux_into_sea_water'
       attname  = 'Forr_roff_16O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(r2x_fluxes,'Forr_roff_18O')
       call seq_flds_add(x2o_fluxes,'Forr_roff_18O')
       longname = 'H2_18O Water flux due to liq runoff '
       stdname  = 'H2_18O_water_flux_into_sea_water'
       attname  = 'Forr_roff_18O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(r2x_fluxes,'Forr_roff_HDO')
       call seq_flds_add(x2o_fluxes,'Forr_roff_HDO')
       longname = 'HDO Water flux due to liq runoff '
       stdname  = 'HDO_water_flux_into_sea_water'
       attname  = 'Forr_roff_HDO'
       call metadata_set(attname, longname, stdname, units)

       call seq_flds_add(r2x_fluxes,'Forr_ioff_16O')
       call seq_flds_add(x2o_fluxes,'Forr_ioff_16O')
       longname = 'H2_16O Water flux due to ice runoff '
       stdname  = 'H2_16O_water_flux_into_sea_water'
       attname  = 'Forr_ioff_16O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(r2x_fluxes,'Forr_ioff_18O')
       call seq_flds_add(x2o_fluxes,'Forr_ioff_18O')
       longname = 'H2_18O Water flux due to ice runoff '
       stdname  = 'H2_18O_water_flux_into_sea_water'
       attname  = 'Forr_ioff_18O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(r2x_fluxes,'Forr_ioff_HDO')
       call seq_flds_add(x2o_fluxes,'Forr_ioff_HDO')
       longname = 'HDO Water flux due to ice runoff '
       stdname  = 'HDO_water_flux_into_sea_water'
       attname  = 'Forr_ioff_HDO'
       call metadata_set(attname, longname, stdname, units)
       ...
       units    = 'm3'
       call seq_flds_add(r2x_states,'Slrr_volr_16O')
       call seq_flds_add(x2l_states,'Slrr_volr_16O')
       longname = 'H2_16O river channel water volume '
       stdname  = 'H2_16O_rtm_volr'
       attname  = 'Slrr_volr_16O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(r2x_states,'Slrr_volr_18O')
       call seq_flds_add(x2l_states,'Slrr_volr_18O')
       longname = 'H2_18O river channel water volume '
       stdname  = 'H2_18O_rtm_volr'
       attname  = 'Slrr_volr_18O'
       call metadata_set(attname, longname, stdname, units)
       call seq_flds_add(r2x_states,'Slrr_volr_HDO')
       call seq_flds_add(x2l_states,'Slrr_volr_HDO')
       longname = 'HDO river channel water volume '
       stdname  = 'HDO_rtm_volr'
       attname  = 'Slrr_volr_HDO'
       call metadata_set(attname, longname, stdname, units)
