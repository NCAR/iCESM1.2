...
!-------------------------------------------------------------------------------
   ...
   use seq_diag_wiso_mct ! diagnostic routines for water isotopes
...
!   endif
   ...
   if (iamin_CPLID) then
      ...
      if (rof_present) then
         ...
         ! --- wiso roff ---
         index_r2x_Forr_roff_16O  = mct_avect_indexRA(r2x_rx(ens1), "Forr_roff_16O" ,perrWith='indexa Forr_roff')
         index_r2x_Forr_ioff_16O  = mct_avect_indexRA(r2x_rx(ens1), "Forr_ioff_16O" ,perrWith='indexa Forr_ioff')
         index_r2x_Forr_roff_18O  = mct_avect_indexRA(r2x_rx(ens1), "Forr_roff_18O" ,perrWith='indexa Forr_roff')
         index_r2x_Forr_ioff_18O  = mct_avect_indexRA(r2x_rx(ens1), "Forr_ioff_18O" ,perrWith='indexa Forr_ioff')
         index_r2x_Forr_roff_HDO  = mct_avect_indexRA(r2x_rx(ens1), "Forr_roff_HDO" ,perrWith='indexa Forr_roff')
         index_r2x_Forr_ioff_HDO  = mct_avect_indexRA(r2x_rx(ens1), "Forr_ioff_HDO" ,perrWith='indexa Forr_ioff')

         index_r2x_Flrr_flood_16O = mct_avect_indexRA(r2x_rx(ens1), "Flrr_flood_16O",perrWith='indexa Flrr_flood')
         index_r2x_Flrr_flood_18O = mct_avect_indexRA(r2x_rx(ens1), "Flrr_flood_18O",perrWith='indexa Flrr_flood')
         index_r2x_Flrr_flood_HDO = mct_avect_indexRA(r2x_rx(ens1), "Flrr_flood_HDO",perrWith='indexa Flrr_flood')
      endif
      if (lnd_present) then
         ...
         index_l2x_Flrl_rofliq_16O = mct_avect_indexRA(l2x_lx(ens1), "Flrl_rofliq_16O",perrWith='indexb Flrl_rofliq')
         index_l2x_Flrl_rofliq_18O = mct_avect_indexRA(l2x_lx(ens1), "Flrl_rofliq_18O",perrWith='indexb Flrl_rofliq')
         index_l2x_Flrl_rofliq_HDO = mct_avect_indexRA(l2x_lx(ens1), "Flrl_rofliq_HDO",perrWith='indexb Flrl_rofliq')
         index_l2x_Flrl_rofice_16O = mct_avect_indexRA(l2x_lx(ens1), "Flrl_rofice_16O",perrWith='indexb Flrl_rofice')
         index_l2x_Flrl_rofice_18O = mct_avect_indexRA(l2x_lx(ens1), "Flrl_rofice_18O",perrWith='indexb Flrl_rofice')
         index_l2x_Flrl_rofice_HDO = mct_avect_indexRA(l2x_lx(ens1), "Flrl_rofice_HDO",perrWith='indexb Flrl_rofice')
         index_x2r_Flrl_rofliq_16O = mct_avect_indexRA(x2racc_lx(ens1), "Flrl_rofliq_16O",perrWith='indexa Flrl_rofliq')
         index_x2r_Flrl_rofliq_18O = mct_avect_indexRA(x2racc_lx(ens1), "Flrl_rofliq_18O",perrWith='indexa Flrl_rofliq')
         index_x2r_Flrl_rofliq_HDO = mct_avect_indexRA(x2racc_lx(ens1), "Flrl_rofliq_HDO",perrWith='indexa Flrl_rofliq')
         index_x2r_Flrl_rofice_16O = mct_avect_indexRA(x2racc_lx(ens1), "Flrl_rofice_16O",perrWith='indexa Flrl_rofice')
         index_x2r_Flrl_rofice_18O = mct_avect_indexRA(x2racc_lx(ens1), "Flrl_rofice_18O",perrWith='indexa Flrl_rofice')
         index_x2r_Flrl_rofice_HDO = mct_avect_indexRA(x2racc_lx(ens1), "Flrl_rofice_HDO",perrWith='indexa Flrl_rofice')
      endif
   endif
...
!tcx is this correct? relation between xao and frc for ifrad and ofrad
   ...
   call seq_diag_zero_wiso_mct(mode='all')
               ...
               if (r2xacc_rx_cnt > 0) then
                  ...
                  do eri = 1,num_inst_rof
                     call seq_map_map(mapper_Rr2o, r2xacc_rx(eri), r2x_ox(eri), &
                                      fldlist='Forr_roff:Forr_ioff:Forr_roff_16O:Forr_ioff_16O: &
                                      Forr_roff_18O:Forr_ioff_18O:Forr_roff_HDO:Forr_ioff_HDO', norm=.false.)
                     if (flood_present) then
                        call seq_map_map(mapper_Fr2o, r2xacc_rx(eri), r2x_ox(eri), &
                                         fldlist='Flrr_flood:Flrr_flood_16O:Flrr_flood_18O: &
                                         Flrr_flood_HDO', norm=.true.)
                        ! add flood to roff and zero flood
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff,:) = &
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff,:) + r2x_ox(eri)%rAttr(index_r2x_Flrr_flood,:)
                        r2x_ox(eri)%rAttr(index_r2x_Flrr_flood,:) = 0.0_r8

                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff_16O,:) = &
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff_16O,:) + r2x_ox(eri)%rAttr(index_r2x_Flrr_flood_16O,:)
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff_18O,:) = &
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff_18O,:) + r2x_ox(eri)%rAttr(index_r2x_Flrr_flood_18O,:)
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff_HDO,:) = &
                        r2x_ox(eri)%rAttr(index_r2x_Forr_roff_HDO,:) + r2x_ox(eri)%rAttr(index_r2x_Flrr_flood_HDO,:)
                        r2x_ox(eri)%rAttr(index_r2x_Flrr_flood_16O,:) = 0.0_r8
                        r2x_ox(eri)%rAttr(index_r2x_Flrr_flood_18O,:) = 0.0_r8
                        r2x_ox(eri)%rAttr(index_r2x_Flrr_flood_HDO,:) = 0.0_r8
                     endif
                  enddo
                  if (do_hist_r2x) then
                     do eri = 1,num_inst_rof
...
!     !        call mct_aVect_accumulate(x2o_ox(eoi), x2oacc_ox(eoi))
      ...
      if (iamin_CPLID .and. lnd_present) then
         do eli = 1,num_inst_lnd
            ...
            if (x2racc_lx_cnt == 0) then
               ...
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_16O,:) = l2x_lx(eli)%rAttr(index_l2x_Flrl_rofliq_16O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_18O,:) = l2x_lx(eli)%rAttr(index_l2x_Flrl_rofliq_18O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_HDO,:) = l2x_lx(eli)%rAttr(index_l2x_Flrl_rofliq_HDO,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_16O,:) = l2x_lx(eli)%rAttr(index_l2x_Flrl_rofice_16O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_18O,:) = l2x_lx(eli)%rAttr(index_l2x_Flrl_rofice_18O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_HDO,:) = l2x_lx(eli)%rAttr(index_l2x_Flrl_rofice_HDO,:)
            else
               ...
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_16O,:) = & 
                   x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_16O,:) + l2x_lx(eli)%rAttr(index_l2x_Flrl_rofliq_16O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_18O,:) = & 
                   x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_18O,:) + l2x_lx(eli)%rAttr(index_l2x_Flrl_rofliq_18O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_HDO,:) = & 
                   x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofliq_HDO,:) + l2x_lx(eli)%rAttr(index_l2x_Flrl_rofliq_HDO,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_16O,:) = & 
                   x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_16O,:) + l2x_lx(eli)%rAttr(index_l2x_Flrl_rofice_16O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_18O,:) = & 
                   x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_18O,:) + l2x_lx(eli)%rAttr(index_l2x_Flrl_rofice_18O,:)
               x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_HDO,:) = & 
                   x2racc_lx(eli)%rAttr(index_x2r_Flrl_rofice_HDO,:) + l2x_lx(eli)%rAttr(index_l2x_Flrl_rofice_HDO,:)
            endif
         end do
      ...
      if (iamin_CPLID .and. do_budgets) then
         ...
         if (lnd_present) then
            ...
            call seq_diag_lnd_wiso_mct(dom_lx, fractions_lx(ens1), l2x_l=l2x_lx(ens1), x2l_l=x2l_lx(ens1))
         endif
         if (rof_present) then
            call seq_diag_rtm_mct(dom_rx, fractions_rx(ens1), r2x_r=r2x_rx(ens1), x2r_r=x2r_rx(ens1))
            call seq_diag_rtm_wiso_mct(dom_rx, fractions_rx(ens1), r2x_r=r2x_rx(ens1), x2r_r=x2r_rx(ens1))
         endif
         if (ocn_present) then
            call seq_diag_ocn_mct(dom_ox, fractions_ox(ens1), o2x_o=o2x_ox(ens1), x2o_o=x2o_ox(ens1), &
                 xao_o=xao_ox(ens1), r2x_o=r2x_ox(ens1))
            call seq_diag_ocn_wiso_mct(dom_ox, fractions_ox(ens1), o2x_o=o2x_ox(ens1), x2o_o=x2o_ox(ens1), &
                 xao_o=xao_ox(ens1), r2x_o=r2x_ox(ens1))
         endif
         if (ice_present) then
            call seq_diag_ice_mct(dom_ix, fractions_ix(ens1), x2i_i=x2i_ix(ens1))
            call seq_diag_ice_wiso_mct(dom_ix, fractions_ix(ens1), x2i_i=x2i_ix(ens1))
         endif
...
!            call seq_hist_spewav('x2a_ax(eai)',gsmap_ax,x2a_ax(eai),atm_nx,atm_ny,1)
      ...
      if (iamin_CPLID .and. do_budgets) then
         ...
         if (atm_present) then
            ...
            call seq_diag_atm_wiso_mct(dom_ax, fractions_ax(ens1), a2x_a=a2x_ax(ens1), x2a_a=x2a_ax(ens1))
         endif
         if (ice_present) then
            call seq_diag_ice_mct(dom_ix, fractions_ix(ens1), i2x_i=i2x_ix(ens1))
            call seq_diag_ice_wiso_mct(dom_ix, fractions_ix(ens1), i2x_i=i2x_ix(ens1))
         endif
         ...
         if (.not. dead_comps) call seq_diag_print_wiso_mct(EClock_d,stop_alarm,budget_inst, &
            budget_daily, budget_month, budget_ann, budget_ltann, budget_ltend)
         call seq_diag_zero_mct(EClock=EClock_d)
         call seq_diag_zero_wiso_mct(EClock=EClock_d)
