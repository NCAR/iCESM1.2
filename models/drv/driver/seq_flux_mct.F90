...
!===============================================================================
  ...
  subroutine seq_flux_atmocnexch_mct( cdata_a, cdata_o, a2x, o2x, xao_a, xao_o, fractions_a, fractions_o)
    ...
    index_evap_16O = mct_aVect_indexRA(xaop_ae,"Faox_evap_16O")
    index_evap_HDO = mct_aVect_indexRA(xaop_ae,"Faox_evap_HDO")
    index_evap_18O = mct_aVect_indexRA(xaop_ae,"Faox_evap_18O")
    ...
    do n = 1,nloc_a2o
       ...
       xaop_oe%rAttr(index_evap_16O ,io) = xaop_oe%rAttr(index_evap_16O  ,io) + evap_16O(n)* wt
       xaop_oe%rAttr(index_evap_HDO ,io) = xaop_oe%rAttr(index_evap_HDO  ,io) + evap_HDO(n)* wt
       xaop_oe%rAttr(index_evap_18O ,io) = xaop_oe%rAttr(index_evap_18O  ,io) + evap_18O(n)* wt
...
!tcx   wt = sMato2a%data%rAttr(kw,n)
       ...
       xaop_ae%rAttr(index_evap_16O ,ia) = xaop_ae%rAttr(index_evap_16O  ,ia) + evap_16O(n)* wt
       xaop_ae%rAttr(index_evap_HDO ,ia) = xaop_ae%rAttr(index_evap_HDO  ,ia) + evap_HDO(n)* wt
       xaop_ae%rAttr(index_evap_18O ,ia) = xaop_ae%rAttr(index_evap_18O  ,ia) + evap_18O(n)* wt
...
!===============================================================================
  ...
  subroutine seq_flux_atmocn_mct( cdata, a2x, o2x, xao)
    ...
    if (first_call) then
       ...
       index_xao_Faox_evap_16O = mct_aVect_indexRA(xao,'Faox_evap_16O')
       index_xao_Faox_evap_HDO = mct_aVect_indexRA(xao,'Faox_evap_HDO')
       index_xao_Faox_evap_18O = mct_aVect_indexRA(xao,'Faox_evap_18O')
       ...
       index_a2x_Sa_shum_16O   = mct_aVect_indexRA(a2x,'Sa_shum_16O')
       index_a2x_Sa_shum_HDO   = mct_aVect_indexRA(a2x,'Sa_shum_HDO')
       index_a2x_Sa_shum_18O   = mct_aVect_indexRA(a2x,'Sa_shum_18O')
       ...
       index_o2x_So_roce_16O = mct_aVect_indexRA(o2x,'So_roce_16O')
       index_o2x_So_roce_HDO = mct_aVect_indexRA(o2x,'So_roce_HDO')
       index_o2x_So_roce_18O = mct_aVect_indexRA(o2x,'So_roce_18O')
       first_call = .false.
    end if
...
!wiso note: shum_* should be multiplied by Rstd_* here?
       ...
       do n = 1,nloc
          if (mask(n) /= 0) then	
             ...
             shum_16O(n) = a2x%rAttr(index_a2x_Sa_shum_16O,n)
             shum_HDO(n) = a2x%rAttr(index_a2x_Sa_shum_HDO,n)
             shum_18O(n) = a2x%rAttr(index_a2x_Sa_shum_18O,n)
             ...
             roce_16O(n) = o2x%rAttr(index_o2x_So_roce_16O, n)
             roce_HDO(n) = o2x%rAttr(index_o2x_So_roce_HDO, n)
             roce_18O(n) = o2x%rAttr(index_o2x_So_roce_18O, n)
...
!                         duu10n,ustar, re  , ssq, missval = 0.0_r8 )
    ...
    do n = 1,nloc
       if (mask(n) /= 0) then	
          ...
          xao%rAttr(index_xao_Faox_evap_16O,n) = evap_16O(n)
          xao%rAttr(index_xao_Faox_evap_HDO,n) = evap_HDO(n)
          xao%rAttr(index_xao_Faox_evap_18O,n) = evap_18O(n)
