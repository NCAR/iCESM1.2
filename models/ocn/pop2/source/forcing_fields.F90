...
! !PUBLIC DATA MEMBERS:
   ...
   integer(kind=int_kind), public :: &
      ...
      PREC_16O_F_nf_ind = 0,   & ! iso-precip index 
      PREC_18O_F_nf_ind = 0,   & ! iso-precip index 
      PREC_HDO_F_nf_ind = 0,   & ! iso-precip index 
      EVAP_16O_F_nf_ind = 0,   & ! iso-evap index 
      EVAP_18O_F_nf_ind = 0,   & ! iso-evap index 
      EVAP_HDO_F_nf_ind = 0,   & ! iso-evap index
      MELT_16O_F_nf_ind = 0,   & ! iso-melt index 
      MELT_18O_F_nf_ind = 0,   & ! iso-melt index 
      MELT_HDO_F_nf_ind = 0,   & ! iso-melt index
      ROFF_16O_F_nf_ind = 0,   & ! iso-roff   index 
      ROFF_18O_F_nf_ind = 0,   & ! iso-roff   index 
      ROFF_HDO_F_nf_ind = 0,   & ! iso-roff   index 
      IOFF_16O_F_nf_ind = 0,   & ! iso-ioff   index 
      IOFF_18O_F_nf_ind = 0,   & ! iso-ioff   index 
      IOFF_HDO_F_nf_ind = 0,   & ! iso-ioff   index 
      ROCE_16O_nf_ind   = 0,   & ! coupler ratio h216o surface 
      ROCE_18O_nf_ind   = 0,   & ! coupler ratio h218o surface
      ROCE_HDO_nf_ind   = 0      ! coupler ratio hdo surface
