  ...
  subroutine atm_export_esmf( cam_out, a2x_a, rc )
    ...
    do c=begchunk, endchunk
       ...
       do i=1,ncols
          ...
          fptr(index_a2x_Faxa_rainc,ig) = (cam_out(c)%precc(i,1)-cam_out(c)%precsc(i,1))*1000._r8
          fptr(index_a2x_Faxa_rainl,ig) = (cam_out(c)%precl(i,1)-cam_out(c)%precsl(i,1))*1000._r8
          fptr(index_a2x_Faxa_snowc,ig) = cam_out(c)%precsc(i,1)*1000._r8
          fptr(index_a2x_Faxa_snowl,ig) = cam_out(c)%precsl(i,1)*1000._r8
