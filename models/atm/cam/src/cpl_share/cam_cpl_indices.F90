...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_x2a_Faxx_evap_16O = mct_avect_indexra(x2a,'Faxx_evap_16O')
    index_x2a_Faxx_evap_HDO = mct_avect_indexra(x2a,'Faxx_evap_HDO')
    index_x2a_Faxx_evap_18O = mct_avect_indexra(x2a,'Faxx_evap_18O')
    ...
    index_a2x_Faxa_rainc_16O= mct_avect_indexra(a2x,'Faxa_rainc_16O')
    index_a2x_Faxa_rainl_16O= mct_avect_indexra(a2x,'Faxa_rainl_16O')
    index_a2x_Faxa_snowc_16O= mct_avect_indexra(a2x,'Faxa_snowc_16O')
    index_a2x_Faxa_snowl_16O= mct_avect_indexra(a2x,'Faxa_snowl_16O')
    index_a2x_Faxa_rainc_HDO= mct_avect_indexra(a2x,'Faxa_rainc_HDO')
    index_a2x_Faxa_rainl_HDO= mct_avect_indexra(a2x,'Faxa_rainl_HDO')
    index_a2x_Faxa_snowc_HDO= mct_avect_indexra(a2x,'Faxa_snowc_HDO')
    index_a2x_Faxa_snowl_HDO= mct_avect_indexra(a2x,'Faxa_snowl_HDO')
    index_a2x_Faxa_rainc_18O= mct_avect_indexra(a2x,'Faxa_rainc_18O')
    index_a2x_Faxa_rainl_18O= mct_avect_indexra(a2x,'Faxa_rainl_18O')
    index_a2x_Faxa_snowc_18O= mct_avect_indexra(a2x,'Faxa_snowc_18O')
    index_a2x_Faxa_snowl_18O= mct_avect_indexra(a2x,'Faxa_snowl_18O')
