...
contains
  ...
  subroutine addglobal (ncid, cmdline)
    ...
    character(len=256):: version = &
         "$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/geotrace_tags/geotrace_44_clm4_0_71/models/lnd/clm/tools/clm4_0/interpinic/src/interpinic.F90 $"
