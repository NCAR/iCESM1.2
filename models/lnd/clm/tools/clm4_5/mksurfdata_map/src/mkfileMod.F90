...
!-----------------------------------------------------------------------
    ...
    str = &
'$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/geotrace_tags/geotrace_44_clm4_0_71/models/lnd/clm/tools/clm4_5/mksurfdata_map/src/mkfileMod.F90 $'
    call check_ret(nf_put_att_text (ncid, NF_GLOBAL, &
