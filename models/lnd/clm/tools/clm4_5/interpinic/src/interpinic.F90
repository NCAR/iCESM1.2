...
contains
  ...
  subroutine addglobal (ncid, cmdline)
    ...
    character(len=256):: version = &
         "$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/geotrace_tags/geotrace_44_clm4_0_71/models/lnd/clm/tools/clm4_5/interpinic/src/interpinic.F90 $"
    character(len=256)  :: revision_id = "$Id: interpinic.F90 45786 2013-04-10 15:56:45Z muszala $"
