...
!
 ...
 !Water isotopes:
 !**************
  integer, public ::index_l2x_Sl_qref_16O     ! 2m reference H216O specific humidity
  integer, public ::index_l2x_Sl_qref_HDO     ! 2m reference HDO specific humidity
  integer, public ::index_l2x_Sl_qref_18O     ! 2m reference H218O specific humidity
  integer, public ::index_l2x_Sl_snowh_16O    ! H216O snow height
  integer, public ::index_l2x_Sl_snowh_HDO    ! HDO snow height
  integer, public ::index_l2x_Sl_snowh_18O    ! H218O snow height
  integer, public ::index_l2x_Fall_evap_16O   ! H216O evaporation water flux
  integer, public ::index_l2x_Fall_evap_HDO   ! HDO evaporation water flux
  integer, public ::index_l2x_Fall_evap_18O   ! H218O evaporation water flux

  integer, public ::index_l2x_Flrl_rofliq_16O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofice_16O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofliq_18O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofice_18O     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofliq_HDO     ! lnd->rtm input fluxes
  integer, public ::index_l2x_Flrl_rofice_HDO     ! lnd->rtm input fluxes
 !**************
  ...
  !Water isotopes:
  !**************
   logical, parameter, public :: tracer_forc_cpl=.false. !isotopic focing?
   integer, public ::index_x2l_Sa_shum_16O     ! H216O bottom atm level spec hum
   integer, public ::index_x2l_Sa_shum_HDO     ! HDO bottom atm level spec hum
   integer, public ::index_x2l_Sa_shum_18O     ! H218O bottom atm level spec hum
   integer, public ::index_x2l_Faxa_rainc_16O  ! H216O prec: liquid "convective"
   integer, public ::index_x2l_Faxa_rainc_HDO  ! HDO prec: liquid "convective"
   integer, public ::index_x2l_Faxa_rainc_18O  ! H218O prec: liquid "convective"
   integer, public ::index_x2l_Faxa_rainl_16O  ! H216O prec: liquid "large scale"
   integer, public ::index_x2l_Faxa_rainl_HDO  ! HDO prec: liquid "large scale"
   integer, public ::index_x2l_Faxa_rainl_18O  ! H218O prec: liquid "large scale"
   integer, public ::index_x2l_Faxa_snowc_16O  ! H216O prec: frozen "convective"
   integer, public ::index_x2l_Faxa_snowc_HDO  ! HDO prec: frozen "convective"
   integer, public ::index_x2l_Faxa_snowc_18O  ! H218O prec: frozen "convective"
   integer, public ::index_x2l_Faxa_snowl_16O  ! H216O prec: frozen "large scale"
   integer, public ::index_x2l_Faxa_snowl_HDO  ! HDO prec: frozen "large scale"
   integer, public ::index_x2l_Faxa_snowl_18O  ! H218O prec: frozen "large scale"  
   !Uncomment when RTM is isotope-enabled:
!   integer, public ::index_x2l_Flrr_flood_16O  ! H216O rof (flood) flux
!   integer, public ::index_x2l_Flrr_flood_HDO  ! HDO rof (flood) flux
!   integer, public ::index_x2l_Flrr_flood_18O  ! H218O rof (flood) flux
  !**************
...
!
! !INTERFACE:
  subroutine clm_cpl_indices_set( atm_prognostic )
...
! !ARGUMENTS:
    ...
    logical           , intent(in)    :: atm_prognostic !Coupled to CAM? - JN, TW
...
!-----------------------------------------------------------------------
   ...
   !Water isotopes:
   !**************
    if( atm_prognostic) then !Using Water Tracers and coupled to iCAM5?
       index_l2x_Sl_qref_16O   = mct_avect_indexra(l2x,'Sl_qref_16O')
       index_l2x_Sl_qref_HDO   = mct_avect_indexra(l2x,'Sl_qref_HDO')
       index_l2x_Sl_qref_18O   = mct_avect_indexra(l2x,'Sl_qref_18O')
       index_l2x_Sl_snowh_16O  = mct_avect_indexra(l2x,'Sl_snowh_16O')
       index_l2x_Sl_snowh_HDO  = mct_avect_indexra(l2x,'Sl_snowh_HDO')
       index_l2x_Sl_snowh_18O  = mct_avect_indexra(l2x,'Sl_snowh_18O')
       index_l2x_Fall_evap_16O = mct_avect_indexra(l2x,'Fall_evap_16O')
       index_l2x_Fall_evap_HDO = mct_avect_indexra(l2x,'Fall_evap_HDO')
       index_l2x_Fall_evap_18O = mct_avect_indexra(l2x,'Fall_evap_18O')
       index_l2x_Flrl_rofliq_16O   = mct_avect_indexra(l2x,'Flrl_rofliq_16O')
       index_l2x_Flrl_rofice_16O   = mct_avect_indexra(l2x,'Flrl_rofice_16O')
       index_l2x_Flrl_rofliq_18O   = mct_avect_indexra(l2x,'Flrl_rofliq_18O')
       index_l2x_Flrl_rofice_18O   = mct_avect_indexra(l2x,'Flrl_rofice_18O')
       index_l2x_Flrl_rofliq_HDO   = mct_avect_indexra(l2x,'Flrl_rofliq_HDO')
       index_l2x_Flrl_rofice_HDO   = mct_avect_indexra(l2x,'Flrl_rofice_HDO')
    end if
   !**************
   ...
   !**************
    if( atm_prognostic) then !Using Water Tracers and coupled to iCAM5?
       index_x2l_Sa_shum_16O   = mct_avect_indexra(x2l,'Sa_shum_16O')   
       index_x2l_Sa_shum_HDO   = mct_avect_indexra(x2l,'Sa_shum_HDO')    
       index_x2l_Sa_shum_18O   = mct_avect_indexra(x2l,'Sa_shum_18O')    
       index_x2l_Faxa_rainc_16O= mct_avect_indexra(x2l,'Faxa_rainc_16O')
       index_x2l_Faxa_rainc_HDO= mct_avect_indexra(x2l,'Faxa_rainc_HDO') 
       index_x2l_Faxa_rainc_18O= mct_avect_indexra(x2l,'Faxa_rainc_18O') 
       index_x2l_Faxa_rainl_16O= mct_avect_indexra(x2l,'Faxa_rainl_16O')
       index_x2l_Faxa_rainl_HDO= mct_avect_indexra(x2l,'Faxa_rainl_HDO')  
       index_x2l_Faxa_rainl_18O= mct_avect_indexra(x2l,'Faxa_rainl_18O') 
       index_x2l_Faxa_snowc_16O= mct_avect_indexra(x2l,'Faxa_snowc_16O')  
       index_x2l_Faxa_snowc_HDO= mct_avect_indexra(x2l,'Faxa_snowc_HDO')  
       index_x2l_Faxa_snowc_18O= mct_avect_indexra(x2l,'Faxa_snowc_18O')  
       index_x2l_Faxa_snowl_16O= mct_avect_indexra(x2l,'Faxa_snowl_16O')  
       index_x2l_Faxa_snowl_HDO= mct_avect_indexra(x2l,'Faxa_snowl_HDO')  
       index_x2l_Faxa_snowl_18O= mct_avect_indexra(x2l,'Faxa_snowl_18O')  
       !Uncomment when RTM is isotope-enabled:    
!       index_x2l_Flrr_flood_16O= mct_avect_indexra(x2l,'Flrr_flood_16O')  
!       index_x2l_Flrr_flood_HDO= mct_avect_indexra(x2l,'Flrr_flood_HDO') 
!       index_x2l_Flrr_flood_18O= mct_avect_indexra(x2l,'Flrr_flood_18O') 
    elseif( tracer_forc_cpl ) then ! using water tracer with DATM, but with isotopic forcing? - TW
       index_x2l_Sa_shum_16O   = mct_avect_indexra(x2l,'Sa_shum')   
       index_x2l_Sa_shum_HDO   = mct_avect_indexra(x2l,'Sa_shum_HDO')    
       index_x2l_Sa_shum_18O   = mct_avect_indexra(x2l,'Sa_shum_18O')    
       index_x2l_Faxa_rainc_16O= mct_avect_indexra(x2l,'Faxa_rainc')
       index_x2l_Faxa_rainc_HDO= mct_avect_indexra(x2l,'Faxa_rainc_HDO') 
       index_x2l_Faxa_rainc_18O= mct_avect_indexra(x2l,'Faxa_rainc_18O') 
       index_x2l_Faxa_rainl_16O= mct_avect_indexra(x2l,'Faxa_rainl')
       index_x2l_Faxa_rainl_HDO= mct_avect_indexra(x2l,'Faxa_rainl_HDO')  
       index_x2l_Faxa_rainl_18O= mct_avect_indexra(x2l,'Faxa_rainl_18O') 
       index_x2l_Faxa_snowc_16O= mct_avect_indexra(x2l,'Faxa_snowc')  
       index_x2l_Faxa_snowc_HDO= mct_avect_indexra(x2l,'Faxa_snowc_HDO')  
       index_x2l_Faxa_snowc_18O= mct_avect_indexra(x2l,'Faxa_snowc_18O')  
       index_x2l_Faxa_snowl_16O= mct_avect_indexra(x2l,'Faxa_snowl')  
       index_x2l_Faxa_snowl_HDO= mct_avect_indexra(x2l,'Faxa_snowl_HDO')  
       index_x2l_Faxa_snowl_18O= mct_avect_indexra(x2l,'Faxa_snowl_18O')  
    end if
   !**************
