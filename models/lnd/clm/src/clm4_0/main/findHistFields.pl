...
#
  ...
  my $svnurl = '$URL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/geotrace_tags/geotrace_44_clm4_0_71/models/lnd/clm/src/clm4_0/main/findHistFields.pl $';
  my $svnid  = '$Id: findHistFields.pl 42841 2012-12-19 15:48:22Z mvertens $';
  print $outfh <<"EOF";
<?xml version="1.0"?>
